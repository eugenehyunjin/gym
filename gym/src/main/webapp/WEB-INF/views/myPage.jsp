...
/*.myPage-table-line{margin-top: 0px;text-align:top;height: 0px;}
.myPage-myInfo, .myPage-table-line{padding-top: 0px;position: static;} **/
.myPage-table-line{padding-top:0px;}
.myInfo-form{margin-top:0px;}
                  ...
                  <div class="row">
                    ...
                    <tr valign="top"><td class = "myPage-table-line">
                                <div class="myPage-myInfo">
                                    <form name="frm" class = "myInfo-form">
