...
#disabledId{background:#c4c4c4;}
	...
	#viewBook{border:1px solid white;margin:30px 20px 0px 0px;padding:10px 5px;width:100%;font-weight: bold;font-size:14px;}
	#viewBook:hover {background-color:white;color:black;border:1px solid black;}
	.opacityChg{opacity: 0.7;background-color:black;}
	.delBtn:hover{color:black;}
	.titleTag{font-weight:bold;color:gray;}
	.titleTag:hover{color:black;}
</style>
...
<script type="text/javascript">
	...
	window.onload = function() {
		...
		for(var h=0;g<optionBirth_d.length;h++) {
			if(myBirth_d == optionBirth_d[h].value){
                ...
                <div class="col-lg-8 p-0 m-auto">
                    <div class="blog-details-text">
						<div class="row">
						  ...
						  <tr valign="top"><td class = "myPage-table-line">
                     		...
                     		<c:forEach var="list" items="${courselist }">
                                				...
                                				<tr class = "myPage-myClass-exist">
                                					<td style = "width:209px;line-height: 240%;">
                                						<ul>
                                							<h5 style="text-align:center;padding-bottom: 10px;">
                                								<a href = "#" class = "tagForBook" title = "커리큘럼 정보">${list.courseid }</a>
                                							</h5>
                                						...
                                						<h7><input type = "button" value = "수강생 정보" onclick="PopUp${list.courseid}()" style = "margin:auto;text-align:center; color:black; border: 1px solid black;font-weight: bold;width:100%;margin-bottom: 10px;" id = "colorChange"></h7>
                                						<script>
                                							function PopUp${list.courseid}(){window.open("${contextPath}/stuInfo_popup.do?name=${myInfo.name}&course_id=${list.courseid}", "수강생 정보", "width=720, height=420, left=500, top=200");}
                                						</script>
                                						<input type = "button" value = "클래스 삭제" onClick="delCourse${list.courseid}()" class = "delBtn"/>
                            							
                                						<script>
                                								function delCourse${list.courseid}(){
                     		...
                     		<table class = "myPage-myClass-table">
                     			...
                     			<c:forEach var="list" items="${booklist }">
	                                ...
	                                <tr class = "myPage-myClass-exist" >
										<td style="width:209px;line-height: 240%;">
											<ul>
											<h5 style = "text-align:center;padding-bottom: 10px;" class="course_id"><a href = "#" class = "titleTag">${list.course_id }</a></h5>
												<li>예약 날짜 - ${list.bookdate }</li>
												<li>강사명 - <a href = "#" class = "tagForMaster" title="강사 정보">${list.master_id }</a></li>
												<li>시작 날짜 - ${list.book_date }</li>										
											</ul>
											<!-- 
											<input type = "button" value = "예약 취소" onClick="delChk${list.course_id}()" class = "delBtn"/>
                                							<script>
                                								function delChk${list.course_id}() {
	                                ...
	                                <br>
                                			...
                                			<div class = "viewBookBtn">
                                				<a href = "${contextPath }/viewBook.do"><input type = "button" value = "예약상세 페이지" id = "viewBook" onClick="viewBook()" title = "예약 상세 정보"/></a>
                                			</div>
                     	</div>           
